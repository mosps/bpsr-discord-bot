...
public class ImagineRemovePageNextAction implements Action {
    ...
    public ActionResult execute(ActionContext context) {
        ...
        if (PageManager.hasNext(session.getRemoveImaginePage(), session.getCurrentImagines().size())) {
            session.nextRemoveImaginePage();
        }
